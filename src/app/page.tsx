...
// engineering, resilience, and continuous growth.
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-2">
          Whether I&apos;m designing data platforms, developing Android applications, or learning a new technology, I
          strive to build solutions that are reliable, maintainable, and built to last. Away from the keyboard,
          you&apos;ll usually find me reading, tackling technical challenges, training, traveling with my wife, or
          giving back to my recovery community. I&apos;m driven by curiosity, resilience, and the belief that the best
          engineers are lifelong students—of both technology and life.
        </p>
