...
export const tradeConcepts: TradeConcept[] = [
  ...
  },
  {
    slug: "tonys-pizza",
    brand: "Tony's Pizza",
    trade: "Classic pizzeria · dine-in, takeout & delivery",
    headline: "The neighborhood slice since 1987",
    desc: "Classic pizzeria · dine-in, takeout & delivery",
    liveUrl: "https://alexbritoofficial.github.io/demo-sites/demo/tonys-pizza",
    footerNote: "Tony's Pizza · Medford, MA",
    features: [
      { title: "Crowd Favorites", desc: "The Original Cheese, Supreme & Hot Honey Pepperoni" },
      { title: "Order Online", desc: "Takeout & delivery in a few taps" },
      { title: "Hours & Location", desc: "Find us in Medford, MA" },
    ],
    // Matches the live site's palette (--site-* CSS variables).
    palette: {
      navBg: "#2a1a14",
      navText: "#fff6ee",
      accent: "#b02318",
      imgBg: "repeating-linear-gradient(45deg,#fbf4e6,#fbf4e6 12px,#f2e6cc 12px,#f2e6cc 24px)",
      bodyBg: "#ffffff",
      textColor: "#2a1a14",
      subText: "#7a6250",
      ctaText: "#fff6ee",
  ...
  },
  {
    slug: "slice-house",
    brand: "Slice House",
    trade: "Wood-fired pizza · dine-in & takeout",
    headline: "Worth the wait",
    desc: "Wood-fired pizza · dine-in & takeout",
    liveUrl: "https://alexbritoofficial.github.io/demo-sites/demo/slice-house",
    footerNote: "Slice House · Somerville, MA",
    features: [
      { title: "Wood-Fired Pies", desc: "Margherita DOP, Sausage & Honey, Hot Soppressata" },
      { title: "Order Online", desc: "Takeout ordering in a few taps" },
      { title: "Hours & Location", desc: "Find us in Somerville, MA" },
    ],
    // Matches the live site's palette (--site-* CSS variables).
    palette: {
      navBg: "#2b2622",
      navText: "#fdf6ee",
      accent: "#c4622d",
      imgBg: "repeating-linear-gradient(45deg,#f6efe6,#f6efe6 12px,#ece1d2 12px,#ece1d2 24px)",
      bodyBg: "#fffdf9",
      textColor: "#2b2622",
      subText: "#7d7267",
      ctaText: "#fdf6ee",
